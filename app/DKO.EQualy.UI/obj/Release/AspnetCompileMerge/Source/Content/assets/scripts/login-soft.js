var Login = function () {
    ...
    var handleRegister = function () {
		...
		function format(state) {
            ...
            return "<img class='flag' src='../content/assets/img/flags/" + state.id.toLowerCase() + ".png'/>&nbsp;&nbsp;" + state.text;
        }
		...
		$("#select2_sample4").select2({
         ...
         $('.register-form').validate({
	            ...
	            messages: { // custom messages for radio buttons and checkboxes
	                ...
	                rpassword: {
	                    equalTo: "Campo senha e re-digite sua senha est&atilde;o diferentes"
	                },
