...
TableTools.BUTTONS = {
	...
	"copy": $.extend( {}, TableTools.buttonBase, {
		...
		"fnComplete": function(nButton, oConfig, flash, text) {
			...
			this.fnInfo( '<h6>Dados da tabela copiados</h6>'+
				'<p>Copiado '+lines+' linha'+plural+'.</p>',
				1500
			);
		}
	} ),
	...
	"print": $.extend( {}, TableTools.buttonBase, {
	    "sInfo": "<h6>Versao para impressao</h6><p>Por favor, use a funcao de impressao do seu navegador para " +
		  "imprimir esta tabela. Digite 'ESC' quando terminar.</p>",
		"sMessage": null,
		"bShowAll": true,
 ...
 */
TableTools.DEFAULTS = {
    "sSwfPath":        "../Content/assets/plugins/data-tables/dataTableToolsExport/swf/copy_csv_xls_pdf.swf",
	"sRowSelect":      "none",
	"sRowSelector":    "tr",
	"sSelectedClass":  null,
	"fnPreRowSelect":  null,
